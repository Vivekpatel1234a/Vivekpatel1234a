...
- 🧩 Consistent **DSA practitioner**, sharpening core problem-solving
- 🎨 Strong eye for **UI/UX** — clean, accessible, and purposeful design
...
AI-powered college prediction platform that helps students shortlist colleges based on rank and preferences.

`React 19` `Vite` `Gemini AI`
...
Civic issue reporting system enabling citizens to report and track local infrastructure problems.
...
High-fidelity, responsive UI replica of Amazon's core storefront experience.
...
<p align="center">
  ...
  <a href="mailto:patelvpv369@gmail.com">
